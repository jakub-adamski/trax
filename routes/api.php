...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('/car/{id}', [CarController::class, 'get']);
    Route::post('/car/create', [CarController::class, 'create']);
    Route::delete('/car/delete/{id}', [CarController::class, 'delete']); // <-- Not used in frontend, just example

    // Cars trips
    Route::get('/cars/trips', [CarTripController::class, 'get']);
    Route::get('/car/trip/{id}', [CarTripController::class, 'get']);
    Route::post('/car/trip/create', [CarTripController::class, 'create']);
    Route::delete('/car/trip/delete/{id}', [CarTripController::class, 'delete']); // <-- Not used in frontend, just example
});
